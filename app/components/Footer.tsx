 ...
 * FOOTER COMPONENT
 *
 * Contains social links, quick nav links, and copyright.
 * Uses semantic <footer> element for accessibility + SEO.
 */
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-text-muted text-sm leading-relaxed max-w-xs">
              Where dedication meets transformation. Your strength journey
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                { label: "Workout Splits", href: "/splits" },
              ].map((link) => (
                <li key={link.label}>
                  <Link
                    href={link.href}
            ...
            <div className="flex gap-4">
              ...
              <a
                ...
                className="w-10 h-10 rounded-full border border-border flex items-center justify-center
                           hover:border-accent hover:text-accent transition-all text-text-muted"
